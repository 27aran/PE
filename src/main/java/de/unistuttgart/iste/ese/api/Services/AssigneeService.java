...
public class AssigneeService {
    ...
    // General email validation: verifies whole email addresses (local part and domain)
    // - forbids leading/trailing '.' in the local part
    // - forbids consecutive '.' in the local part
    // - requires a domain with at least one dot and a TLD of length >=2
